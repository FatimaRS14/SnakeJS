...
const bgSound = new Audio('./vodevil-15550.mp3');
const eating = new Audio('./nom_c_06-89142.mp3');
const death= new Audio('./wah-wah-sad-trombone-6347.mp3');
...
function init(){
    ...
    const snake = []; //se utilizara como un Array
    const head = {
        x: 2,
        y: 1,
        pinta: function(){
...
//Se manda a llamar la funcion nexMove
